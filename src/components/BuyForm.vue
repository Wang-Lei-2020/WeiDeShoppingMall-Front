        ...
        <div>
          <div>
            <el-row>
              ...
              <el-col span="7">
                <div style="padding: 0px;" class="info">
                  <span>商品名: {{ getCommodityName }} </span>
                  <div class="bottom clearfix">
                    <div class="shopKind" style="height: 2em"> 商品价格: ￥{{ getCommodityPrice }}</div>
                    <div class="shopKind" style="height: 2em"> 剩余数量: {{ getCommodityLeft }}  件</div>
                    <div class="shopKind" style="height: 2em"> 已售数量: {{ getCommoditySold }}  件</div>
                  </div>
                </div>
              </el-col>
            </el-row>
            ...
            <el-row>
              <el-col span="6" class="buyNum"> 购买数量: </el-col>
              <el-col span="15">
                <div class="buttonRight">
                  <el-button type="success" icon="el-icon-plus" plain circle class="button"
                             v-on:click="buyNum++"></el-button>
                  <el-input v-model="buyNum" style="width: 13%" class="button"></el-input>
                  <el-button type="warning" icon="el-icon-minus" plain circle class="button"
                             v-on:click="buyNum--"></el-button>
                </div>
              </el-col>
            </el-row>
            ...
            <el-row v-if="isWeChat" class="juzhong">
              <el-col span="15">
                <img src="../assets/WeChat支付.jpg" alt="微信支付" width="100%" class="image">
              </el-col>
              <el-col span="7">
                <el-button type="success" class="paySuccess"
                           v-on:click="paySuccess()">支付成功</el-button>
              </el-col>
            </el-row>
            <el-row v-if="isWeChat" class="payText">
              <el-col>微信支付</el-col>
            </el-row>

            <el-row v-if="isZhiFuBao" class="juzhong">
              <el-col span="15">
                <img src="../assets/支付宝支付.jpg" alt="支付宝支付" width="100%" class="image">
              </el-col>
              <el-col span="7">
                <el-button type="primary" class="paySuccess"
                           v-on:click="paySuccess()">支付成功</el-button>
              </el-col>
            </el-row>
            <el-row v-if="isZhiFuBao" class="payText">
              <el-col>支付宝支付</el-col>
            </el-row>

            <el-row v-if="isQianBao" class="juzhong">
              <el-col span="15">
                <img src="../assets/支付宝支付.jpg" alt="支付宝支付" width="100%" class="image">
              </el-col>
              <el-col span="7">
                <el-button type="warning" class="paySuccess"
                           v-on:click="paySuccess()">支付成功</el-button>
              </el-col>
            </el-row>
            <el-row v-if="isQianBao" class="payText">
              <el-col>钱包支付</el-col>
            </el-row>
