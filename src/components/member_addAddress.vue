          ...
          <div class="request-menu wrap mgt30">
            <div class="input-group mgt30" >
              <div class="input-group mgt15">
                ...
                <v-distpicker @province="onChangeProvince" @city="onChangeCity" @area="onChangeArea" @selected="onSelected"></v-distpicker>
              ...
              <div class="input-group mgt15">
                ...
                <input v-model="userAddress.addressInfo" type="text" class="fl j-num" style= "background-color:#F5F5F5;border:0;" placeholder="请输入详细地址，例：****路/****号/****房间"/>
                <span>&nbsp;</span>
                <div class="clear"></div>
              </div>
                <label class="fl"><b>*</b>收货人</label>

                <input v-model="userAddress.receiver" type="text" class="fl j-num" style= "background-color:#F5F5F5;border:0;"  placeholder="请输入收货人"/>
                <span>&nbsp;</span>
...
<!--              <el-form-item label="名称" v-if="type" required>-->
                ...
                <input v-model="userAddress.phone" type="text" class="fl j-num" style= "background-color:#F5F5F5;border:0;" placeholder="请输入手机号/座机号，例：135********/****_*******"/>
                <span>&nbsp;</span>
<!--              </el-form-item>-->
              <div class="clear"></div>
            </div>
...
<!--          </div>-->
          <div class="wid100 tac">
            <a v-on:click="toAddress"><button type="primary"  @click="onAddAddress" class="mgt50 tac submit-request j-sr">提交</button></a>
          </div>
        </div>
...
<script src="https://cdn.bootcss.com/jquery/3.3.1/jquery.js" rel="stylesheet"></script>
