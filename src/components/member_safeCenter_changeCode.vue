...
<!--                <a href=""><img class="round-image" width="50" height="50" src="../assets/touxiang.jpg" alt="头像"></a>-->
<!--                <div class="name-job">-->
<!--                  <h4 class="myname"> test_user </h4>-->
...
<!--            <ul class="nav panel">-->
<!--              <li>-->
<!--                <a href="member_qianbao.html"><i class="icon-nav icon-tick"></i>我的钱包</a>-->
<!--              </li>-->
<!--              <li>-->
<!--                <a href="member_shoucang.html"><i class="icon-nav icon-note"></i>我的收藏</a>-->
<!--              </li>-->
<!--              <li>-->
<!--                <a href="member_dizhi.html"><i class="icon-nav icon-plan"></i>购物车</a>-->
<!--              </li>-->
<!--              <li>-->
...
<!--              </li>-->
<!--              <li>-->
<!--                <a href="member_safe.html"><i class="icon-nav icon-ques"></i>安全中心</a>-->
<!--              </li>-->

<!--              <li style='border-bottom: none'>-->
<!--                <a href="member_message.html" class=""><i class="icon-nav icon-msg"></i>我的消息</a>-->
<!--              </li>-->
<!--            </ul>-->
<!--          </div>-->
<!--          <div class="member_per">-->
...
<!--            <iframe src="/safeCenter_changeCode.html" scrolling="no" style="width: 1000px;height: 1500px;" frameborder="0"></iframe>-->
<!--          </div>-->
...
<!--export default {-->
<!--  name: "member_safeCenter_changeCode",-->
<!--  methods: {-->
<!--    toAddress: function () {-->
        ...
        <div class="member_right">
          ...
          <div class="member_per">
            <ul class="nav panel">
              ...
              <li>
                <a v-on:click="toShopCart"><i class="icon-nav icon-plan"></i>购物车</a>
              </li>
              <li>
                <a v-on:click="toAddress"><i class="icon-nav icon-plan"></i>我的地址</a>
              </li>
          ...
          <div class="infoPerBlock infoCommentBlock ">
            ...
            <div class="request-menu wrap mgt30">
              <div class="input-group mgt30" >
                <label class="fl">请输入密码</label>
                <input type="text" id="get1" class="fl j-num" style= "background-color:#F5F5F5;border:0;"  placeholder="请输入新密码"/>
                <span>&nbsp;</span>
                <div class="clear"></div>
              </div>
              <div class="input-group mgt15">
                <label class="fl">请确认密码</label>
                <input type="text" id="get2" class="fl j-num get2" style= "background-color:#F5F5F5;border:0;" placeholder="请确认新密码"/>
                <span>&nbsp;</span>
                <div class="clear"></div>
              </div>
            ...
            <a align="center" style="position:relative;" v-on:click="toUpdatePassword"><button type="primary"  onclick="toUpdatePassword" class="mgt50 tac submit-request j-sr">提交</button></a>
...
export default {
  ...
  methods: {
    ...
    toUpdatePassword: function() {
      if(document.getElementById("get1").value!=document.getElementById("get2").value){
        alert("两次密码不一致！")
        return
      }
      this.newUser.name=localStorage.getItem("username")
      this.newUser.password=document.getElementById("get1").value
      this.newUser.telephone="123"
      this.newUser.email="123"
      const _this = this
      this.$axios.post(
          '/modifyPwd',
          _this.newUser,
        ...
        if (response.data.code == '0') {
          ...
          _this.$router.push({name: "index", params: {msg: '更改密码成功！'}});
        } else {
