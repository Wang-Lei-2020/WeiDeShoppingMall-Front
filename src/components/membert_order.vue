      ...
      <div class="container clearfix">
        ...
        <div class="member_main" id='member_index'>
          <div class="perInfo">
            ...
            <!--            <iframe src="/test.html" scrolling="no" style="width: 100%;height: 1500px;" frameborder="0"></iframe>-->

            <div class="m_content" style="background-color:white">
              <h3>订单管理</h3>
              <div class="zqrightinfo zqtwo">
                <div class="zqtypesh">
                  <p class="zqstate tab-switch">
                    <a href="#" class="active all">全部订单</a> <b>|</b>
                    <a href="#" class="closed">
                      已关闭
                      <span id="closeorder">(29)</span>
                    </a>
                  </p>

                </div>
                <!--框架里面的内容  -->
                <div class="zqboxright" id="usercenterOrder">
                  <!-- 全部订单 -->
                  <el-col  v-for="(order) in orderList" :key="order.orderId" >
                    <li>
                      <div class="zqinfo">
                        <p v-if="order.states==1" class="zqtype red">
                          交易完成
                          <span class="zqtype-time"></span>
                        </p>
                        <p v-if="order.states==2" class="zqtype red">
                          等待卖家确认取消交易
                          <span class="zqtype-time"></span>
                        </p>
                        <p v-if="order.states==3" class="zqtype red">
                          交易取消
                          <span class="zqtype-time"></span>
                        </p>
                        <p class="zqddinfo m_list_bor">
								<span class="zqtminfo">
									{{ order.buyTime }}
									<b>|</b>
									收货手机号:{{ order.phone }}
									...
									收货人:{{ order.receiver }}
                                    <b>|</b>
									{{ order.addressName }}&nbsp;{{order.addressInfo}}
									<b>|</b>
									订单号 : {{ order.orderId }}
                          ...
                          <span class="zqpaymy">
									订单金额：
									<span class="zqbtxt">{{ order.price }}</span>
									元
								</span>
                        </p>
                        <div class="zqproinfo clearfloat">
                          <form class="zqthreebtn">
                            <input @click="commentMethod(order.commodityId,order.commodityName,order.price,order.url)" type="button" class="y_btn y_btn_custom2" id="button2" value="评价">
                          </form>

                          <form class="zqthreebtn">
                            <input v-on:click="cancelOrder(order.orderId)" type="button" class="y_btn y_btn_custom2" id="button4" value="取消订单">
                          </form>
                          <div class="w650 fl">
                            <div class="zqimgtxt fl">
                              ...
                              <div class="zqittxt">
                                <p class="zqpmiaoshu">
                                  <a href="" target="_blank">{{ order.commodityName }}</a>
                                </p>
                                <p class="price-num">
                                  <!--                              <span class="product-price">0.03元</span>-->
                                  <!--                              ×-->
                                  <!--                              <span class="zqno">1</span>-->
                                </p>
                              </div>
                            </div>
                          </div>
                  ...
                  <!--                  <div class="reson-tip hidden"></div>-->
                  <!--                  <div class="modal-backdrop"></div>-->
                  <!--                  <div class="reson-dialog hidden">-->
                  <!--                    <h3 class="m_rel">-->
                  <!--                      <s class="m_close"></s>-->
                  <!--                    </h3>-->
                  <!--                    <div class="reson-title">取消原因</div>-->
                  <!--                    <div class="dialog_tit">-->
                  <!--                      <select name="reasons" id="reasons" class="form_control">-->
                  <!--                        <option value="不想买了" selected="selected">不想买了</option>-->
                  <!--                        <option value="重新下单">重新下单</option>-->
                  <!--                        <option value="再考虑一段时间再买">再考虑一段时间再买</option>-->
                  <!--                      </select>-->
                  <!--                      <h3>描述</h3>-->
                  <!--                      <textarea placeholder="请填写取消原因" id="reasoncontent" class="form_control" maxlength="100"></textarea>-->
                  <!--                    </div>-->
                  <!--                    <div class="dialog-tip m_hide red">填写100字以内的描述信息(*非必须)</div>-->
                  <!--                    <div class="m_btn">-->
                  <!--                      <div class="m_btn_box">-->
                  <!--                        <a href="javascript:cancelOrder();" class="y_btn y_btn_custom1 sure">确定</a>-->
                  <!--                        <a href="javascript:;" class="y_btn y_btn_custom4 clean">取消</a>-->
                  <!--                      </div>-->
                  <!--                    </div>-->
                  <!--                  </div>-->
                </div>
...
export default {
  ...
  methods: {
    commentMethod: function(commodityID,commodityName,commodityPrice,commodityUrl){
    ...
    cancelOrder: function (orderId) {
      ...
      this.$axios.post(
        ...
        if (response.data.code == '0') {
          ...
          _this.$router.push({name: "Login", params: {msg: '用户取消成功！'}});
    ...
    getOrderList: function () {
      ...
      this.$axios.post('/order/orderList', formData, {
        headers: {
          "Content-Type": "application/json;charset=utf-8"
        },
        withCredentials: true
        ...
        _this.totalOrder = response.data.data.total;
