    ...
    <div class="container clearfix">
      ...
      <div class="member_main" id='member_index'>
        ...
        <div class="infoPerBlock infoCommentBlock ">
          ...
          <div class="request-menu wrap mgt30">
            <div class="input-group mgt30" >
              <div class="input-group mgt15">
                <label class="fl"><b>*</b>城市/区域</label>
                <v-distpicker :province="sheng"
                              :city="shi"
                              :area="xian"
                ...
                <!--              <v-distpicker  :class="{'disabled-select': dialogStatus=='update'}" :province="temp.address__province" :city="temp.address__city" :area="temp.address__dist" @selected="onSelected"></v-distpicker>-->

                <!--              <div id="areasId" class="col-sm-3">-->
                <!--                <div id="citys" class="col-sm-12"></div>-->
                <!--              </div>-->
                <!--              <div id="regionsId" class="col-sm-3">-->
                <!--                <div id="regions" class="col-sm-12"></div>-->
                <!--              </div>-->
                <!--              <div id="streets" class="col-sm-3"></div>-->
              </div>
              <div class="input-group mgt15">
                <label  class="fl"><b>*</b>详细地址</label>
                <input id="dzz" type="text" class="fl j-num" style= "background-color:#F5F5F5;border:0;" :value="dizhi"/>
                <span></span>
                <div class="clear"></div>
              </div>
              <label class="fl"><b>*</b>收货人</label>
              <input id="shr" type="text" class="fl j-num" style= "background-color:#F5F5F5;border:0;" :value="receiver"/>
              <span>&nbsp;</span>
            ...
            <div class="input-group mgt15">
              ...
              <label class="fl"><b>*</b>联系手机号</label>
              <input id="sjh" type="text" class="fl j-num" style= "background-color:#F5F5F5;border:0;" :value="phone"/>
              <span>&nbsp;</span>
              <!--              </el-form-item>-->
              <div class="clear"></div>
            </div>
          ...
          <div class="input-group mgt15">
            <label class="fl"><b>*</b>验证码</label>
            <input type="text" class="fl j-code code-num" maxlength="100"/>
            <img src="img/code.gif" class="code"/>
            <a class="fsize_12" href="javascript:void(0);">看不清，换一个</a>
          </div>
          <div class="wid100 tac">
            <a ><button type="primary"  @click="onUpdateAddress" class="mgt50 tac submit-request j-sr">提交更改</button></a>
          </div>
        </div>
...
if(localStorage.getItem('TEMPaddressName')!=null) {
  var words = localStorage.getItem('TEMPaddressName').split('-')
}

setTimeout( function(){
  // eslint-disable-next-line no-undef
  this.dizhi= localStorage.getItem('TEMPaddressAddressInfo');
  this.phone= localStorage.getItem('TEMPaddressPhone');
  this.receiver= localStorage.getItem('TEMPaddressReceiver');
},2000);


// if( document.getElementById("dzz").value == "undefined" ) {
//   location.reload()
// }
export default {
  ...
  data(){
    ...
    sheng: words[0],
      shi: words[1],
      xian: words[2],
      dizhi: localStorage.getItem('TEMPaddressAddressInfo'),
      phone: localStorage.getItem('TEMPaddressPhone'),
      receiver: localStorage.getItem('TEMPaddressReceiver'),
      addressInfo: {
        id: localStorage.getItem('TEMPorderID'),
  ...
  methods: {
    ...
    onChangeProvince(a){
      console.log(a)
      this.temp.address__province = a.value + '-'

    },
    onChangeCity(a){
      console.log(a)
      this.temp.address__city = a.value + '-'
    ...
    onSelected(data){
      ...
      this.userAddress.userId=localStorage.getItem('userId')
      ...
      this.userAddress.name=this.temp.address__province+this.temp.address__city+this.temp.address__dist

    },
    onUpdateAddress:function(){
      console.log("自动触发事件")
      this.addressInfo.addressInfo =  document.getElementById("dzz").value
      console.log(this.addressInfo.addressInfo)
      this.addressInfo.receiver =  document.getElementById("shr").value
      console.log(this.addressInfo.receiver)
      this.addressInfo.phone = document.getElementById("sjh").value
      console.log(this.addressInfo.phone)
      this.addressInfo.name=this.temp.address__province+this.temp.address__city+this.temp.address__dist
      ...
      this.$axios.post(
        ...
        if(response.data.code == '0') {
          ...
          _this.$router.push({name: "address", params: {msg: '用户添加地址成功！'}});
        } else {
...
.input-group .form-group  .selectAddress{
  background-color: #f5f5f5;
  font-family: "微软雅黑";
  height: 45px;
  line-height: 45px;
...
.input-group .form-group .col-sm-3{
  float:left;
  width:100px;
  margin:0 5px;
}
...
#bigbuyform .col-sm-3 .parsley-errors-list {
  margin:0;
}
