<template>
  <el-form>
    <el-form-item label="上传店铺图片" prop="picture">
      <el-upload
    ...
    <el-form-item>
      <el-button style="margin-left: 150px" type="primary" @click="changeShopPhoto()">提交</el-button>
    </el-form-item>
...
export default {
  ...
  methods: {
    changeShopPhoto:function(){
        ...
        localStorage.setItem('shopPhotoUrl', _this.uploadPicUrl)

        this.$axios.post('/modify/sellerPhoto', fd, {
          headers: {
